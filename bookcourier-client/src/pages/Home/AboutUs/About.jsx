      ...
      <div className="w-11/12 mx-auto py-16">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-28">
          ...
          >
            ...
            <h1 className={`text-4xl md:text-5xl lg:text-6xl font-extrabold ${isDark ? "text-white" : "text-black"} mb-6 leading-tight`}>
              Driven to{" "}
            ...
            <p className={`text-lg ${isDark ? "text-white" : "text-black"} mb-6 leading-relaxed font-medium`}>
            ...
            <p className={`${isDark ? "text-gray-200" : "text-black"} mb-10 leading-relaxed`}>
        ...
        <div className="mb-20">
          ...
          >
            ...
            <h3 className={`text-3xl md:text-4xl font-bold ${isDark ? "text-white" : "text-black"}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className={`text-xl font-bold mb-3 ${isDark ? "text-white" : "text-black"} group-hover:text-primary transition-colors duration-300`}>
                  {feature.title}
                </h3>
                <p className={`${isDark ? "text-gray-200" : "text-black"} leading-relaxed`}>
                  {feature.description}
                </p>
              </motion.div>
            ))}
        ...
        <div id="Add New  Sectionns" className="space-y-20 mb-24">
          ...
          >
            <div className="flex flex-col md:flex-row items-center gap-10">
              ...
              <div className="md:w-2/3">
                <h2 className={`text-3xl md:text-4xl font-bold ${isDark ? "text-white" : "text-black"} mb-6`}>
                  Our Story
                </h2>
                <p className={`text-lg ${isDark ? "text-white" : "text-black"} leading-relaxed`}>
          ...
          >
            <h2 className={`text-3xl md:text-4xl font-bold ${isDark ? "text-white" : "text-black"} mb-10 text-center`}>
              Why Choose Us?
            </h2>
          ...
          >
            <h2 className={`text-3xl md:text-4xl font-bold ${isDark ? "text-white" : "text-black"} mb-12 text-center`}>
              How It Works
            </h2>
            <div className="grid md:grid-cols-3 gap-10 relative">
              ...
              {[
                ...
                <div key={index} className="text-center relative z-10">
                  ...
                  <h3 className={`text-2xl font-bold ${isDark ? "text-white" : "text-black"} mb-3`}>
                    {item.title}
                  </h3>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                ...
                >
                  ...
                  <p className={`${isDark ? "text-gray-200" : "text-black"} text-sm`}>
                    {item.desc}
                  </p>
                </div>
              ))}
          ...
          >
            ...
            <div className="space-y-6 max-w-4xl mx-auto">
              {[
                ...
                >
                  <h3 className={`text-lg font-bold ${isDark ? "text-white" : "text-black"} mb-3 flex items-center gap-3`}>
                    <span className="text-primary">Q.</span> {item.q}
                  </h3>
                  <p
                    className={`${isDark ? "text-gray-200" : "text-black"} pl-8 border-l-2 ${
                      isDark ? "border-gray-700" : "border-orange-100"
                    }`}
                  >
                    {item.a}
          ...
          >
            <h2 className={`text-3xl md:text-4xl font-bold ${isDark ? "text-white" : "text-black"} mb-12`}>
              Get in Touch
            </h2>
